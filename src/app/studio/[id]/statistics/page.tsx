    ...
    <div className="min-h-screen bg-[#131618]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">View detailed analytics for {studio.name}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#1A1C21] border border-[#2A2D30] rounded-lg p-6">
            ...
            <p className="text-2xl font-bold text-[#FDD811]">12,543</p>
          ...
          <div className="bg-[#1A1C21] border border-[#2A2D30] rounded-lg p-6">
            ...
            <p className="text-2xl font-bold text-[#FDD811]">22.7%</p>
        ...
        <div className="bg-[#1A1C21] border border-[#2A2D30] rounded-lg p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Advanced Statistics Coming Soon</h2>
