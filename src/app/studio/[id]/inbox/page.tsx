    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-text-secondary">Manage messages and communications for {studio.name}</p>
        </div>

        {/* Inbox Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-background-secondary border border-border rounded-lg p-6">
            <h3 className="text-sm font-medium text-text-secondary mb-2">Unread Messages</h3>
            <p className="text-2xl font-bold text-primary">3</p>
          </div>
          
          <div className="bg-background-secondary border border-border rounded-lg p-6">
            <h3 className="text-sm font-medium text-text-secondary mb-2">Total Messages</h3>
            <p className="text-2xl font-bold text-primary">47</p>
          </div>
          
          <div className="bg-background-secondary border border-border rounded-lg p-6">
            <h3 className="text-sm font-medium text-text-secondary mb-2">Response Rate</h3>
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-text-primary mb-4">Recent Messages</h2>
          <div className="space-y-4">
            <div className="flex items-start space-x-4 p-4 bg-background border border-border rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-text-primary font-medium">John Doe</h3>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-text-secondary">Product Inquiry</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-4 bg-background border border-border rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-text-primary font-medium">Sarah Miller</h3>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-text-secondary">Custom Request</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-4 bg-background border border-border rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-text-primary font-medium">Mike Johnson</h3>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-text-secondary">Feedback</span>
                </div>
              </div>
            </div>
          </div>
