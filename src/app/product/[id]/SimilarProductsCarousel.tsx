  ...
  return (
    <div className="bg-transparent">
      <div className="max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex justify-center mb-5 sm:mb-6 mt-5 sm:mt-0">
            ...
            <div className="px-4 sm:px-0" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
              <div style={{ paddingLeft: '0px', paddingRight: '0px' }} className="sm:hidden">
                <h2 className="text-3xl font-extrabold">
                  <span className="text-orange-500">SIMILAR</span>
                  <span className="text-white"> PRODUCTS</span>
                </h2>
                <p className="text-gray-400 mt-1 text-sm">Products with similar tags</p>
              </div>
              <div style={{ paddingLeft: '40px', paddingRight: '40px' }} className="hidden sm:block">
                ...
                <p className="text-gray-400 mt-1 text-base">Products with similar tags</p>
              </div>
            </div>
          </div>
        </div>
